...
public class ScheduleChildFragment2 extends BaseFragment<SchedulleChildFragment1Binding> {
    ...
    public void initView() {
        ...
        mViewModel = new ViewModelProvider(this).get(ScheduleChildModel2.class);
...
//                    getActivity().findViewById(R.id.dialog_load_schedule1).setVisibility(View.GONE);
    ...
    @NonNull
    @Override
    public SchedulleChildFragment1Binding getViewBinding() {
        return SchedulleChildFragment1Binding.inflate(getLayoutInflater());
    }
}
