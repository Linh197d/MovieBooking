...
public class ScheduleChildFragment extends BaseFragment<SchedulleChildFragmentBinding> {
    ...
    public void initView() {
        ...
        mViewModel = new ViewModelProvider(this).get(ScheduleChildModel.class);
    ...
    @NonNull
    @Override
    public SchedulleChildFragmentBinding getViewBinding() {
        return SchedulleChildFragmentBinding.inflate(getLayoutInflater());
    }
}
