...
public class ScheduleChildFragment7 extends BaseFragment<SchedulleChildFragment6Binding> {
    ...
    public void initView() {
        ...
        mViewModel = new ViewModelProvider(this).get(ScheduleChildModel7.class);
...
//                    getActivity().findViewById(R.id.dialog_load_schedule6).setVisibility(View.GONE);
    ...
    @NonNull
    @Override
    public SchedulleChildFragment6Binding getViewBinding() {
        return SchedulleChildFragment6Binding.inflate(getLayoutInflater());
    }
}
