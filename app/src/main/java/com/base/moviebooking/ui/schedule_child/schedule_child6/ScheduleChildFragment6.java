...
public class ScheduleChildFragment6 extends BaseFragment<SchedulleChildFragment5Binding> {
    ...
    public void initView() {
        ...
        mViewModel = new ViewModelProvider(this).get(ScheduleChildModel6.class);
...
//                    getActivity().findViewById(R.id.dialog_load_schedule5).setVisibility(View.GONE);
    ...
    @NonNull
    @Override
    public SchedulleChildFragment5Binding getViewBinding() {
        return SchedulleChildFragment5Binding.inflate(getLayoutInflater());
    }
}
